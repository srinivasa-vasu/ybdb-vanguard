...
```
yb-voyager export data status --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data
```
...
```
yb-voyager import schema --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data \
...
```
yb-voyager import data --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data \
        --target-db-host 127.0.0.1 \
        --target-db-user ${TARGET_USER} \
        --target-db-password ${TARGET_SECRET} \
        --target-db-name ${TARGET_DB_ID} \
...
```
yb-voyager import data status --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data
```
...
```
yb-voyager finalize-schema-post-data-import --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data \
        --target-db-host 127.0.0.1 \
        --target-db-user ${TARGET_USER} \
        --target-db-password ${TARGET_SECRET} \
        --target-db-name ${TARGET_DB_ID} \
...
```
yb-voyager end migration --export-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data \
        --backup-log-files yes \
        --backup-data-files no \
        --backup-schema-files yes \
        --save-migration-reports yes \
        --backup-dir /workspaces/ybdb-vanguard/init-voyager-mysql/voyager-data/backup
```
